...
layout: post
title: Markdown写作说明
description: 举例说明基于 Jekyll + Github Pages 的博客系统，如何正确使用 Markdown 进行博客写作。
categories: [Jekyll]
extMath: true
toc: true
---
...
破事水![line](/blog/2022/09/18/emoji_01.png)
滑稽![line](/blog/2022/09/18/emoji_02.png)

```md
![line](/blog/YY/MM/DD/xx.jpg)
```

块级别图片

```md
![测试图片](/blog/YY/MM/DD/001.jpg)
```

![测试图片](/blog/2022/09/18/001.jpg)
